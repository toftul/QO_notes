...
\begin{equation}\label{kminsk}
	...
	\begin{hw}[Deadline: 13th of October]
		...
		%\item (2 pt) What are the nonzero matrix elements of the operator $\ap\ap a$ in Fock's represntation~?
		%\item Consider two interacting
