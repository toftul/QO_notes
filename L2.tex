...
\end{equation}
Here we see that $\Delta p_{\alpha} \Delta q_{\alpha}$ relation does not depend on $\alpha$! In fact we obtained a shifted Fock state (fig \ref{fig:shifted_Fock}).

\begin{figure}
	\centering
	\includegraphics[width=0.8\linewidth]{fig/L2/shifted_Fock}
