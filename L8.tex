...
\begin{numcases}{}
	...
	\label{eq:M1_j} \\
	\Rot \vec{H} = \frac{1}{c} \parder{\vec{E}}{t} + \frac{4 \pi}{c} \vec{j},
	\label{eq:M2_j} \\
	\Div \vec{D} = 4 \pi \rho,
	\label{eq:M3_j} \\
	\Div \vec{B} = 0.
...
\begin{numcases}{\label{eq:gelm}}
	\Delta \vec{A} + k^2 \vec{A} = - \frac{4 \pi}{c} \vec{j}, \\
...
\begin{numcases}{}
	\vec{A}(\vec{r}) = \frac{4 \pi}{c} \int d^3 r' G_0(\vec{r}, \vec{r}') \hat{\vec{I}} \vec{j}(\vec{r}'), \\
	\varphi(\vec{r}) = 4\pi \int d^3r' G_0(\vec{r}, \vec{r}') \rho(\vec{r}'),
	\label{eq:solll}
\end{numcases}
